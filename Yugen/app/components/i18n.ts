...
const es: Dictionary = {
  ...
  "avaliações": "valoraciones", "Aguardando avaliações": "Esperando valoraciones", "Assistindo": "Viendo", "Assistido": "Visto", "Adicionar à coleção": "Añadir a colección", "Visão geral": "Resumen", "Relações": "Relaciones", "Personagens": "Personajes", "Equipe": "Equipo", "Músicas-tema": "Canciones temáticas", "Avaliações": "Reseñas",
