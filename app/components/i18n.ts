...
const en: Dictionary = {
  ...
  "Sugestões de anime": "Anime suggestions", "Sugestões de anime e perfis": "Anime and profile suggestions", "Animes": "Anime", "Perfis": "Profiles", "Perfis encontrados": "Profiles found", "Pessoas no Yugen": "People on Yugen", "Pesquisando perfis…": "Searching profiles…", "Pressione Enter para pesquisar tudo": "Press Enter to search all", "Buscando animes e perfis…": "Searching anime and profiles…",
...
const es: Dictionary = {
  ...
  "Pressione Enter para pesquisar tudo": "Pulsa Enter para buscar todo", "Buscando animes e perfis…": "Buscando anime y perfiles…", "Não foi possível carregar as sugestões.": "No se pudieron cargar las sugerencias.",
...
Object.assign(en, {
  ...
  "Conteúdo indisponível no momento.": "Content is temporarily unavailable.",
  "Não foi possível carregar esta seção. Tente novamente em alguns instantes.": "This section could not be loaded. Try again in a moment.",
  "Destaques temporariamente indisponíveis": "Highlights temporarily unavailable",
  "Em alta nesta temporada": "Trending this season",
  "Não foi possível carregar os destaques agora. Tente novamente em alguns instantes.": "Highlights could not be loaded right now. Try again in a moment.",
  "Preparando os destaques mais recentes…": "Preparing the latest highlights…",
  "Personagens do Yugen": "Yugen characters",
  "Não foi possível carregar este personagem no momento.": "This character could not be loaded right now.",
  "Perfil de personagem": "Character profile",
  "favoritos na comunidade": "community favorites",
  "Explore o catálogo Yugen": "Explore the Yugen catalog",
  "Descubra sinopses, trailers, personagens e detalhes de produção em um só lugar.": "Discover synopses, trailers, characters, and production details in one place.",
  "Catálogo Yugen": "Yugen catalog",
  "Anime não encontrado.": "Anime not found.",
  "Este endereço não corresponde a um anime disponível no Yugen.": "This address does not match an anime available on Yugen.",
  "Explorar catálogo": "Explore catalog",
  "Carregando informações do anime": "Loading anime information",
  "Anime indisponível no momento.": "Anime temporarily unavailable.",
  "Não foi possível carregar as informações deste anime. Tente novamente em alguns instantes.": "This anime's information could not be loaded. Try again in a moment.",
  "Informações do anime": "Anime information",
  "Use as informações atuais como ponto de partida e sugira correções. Nada é publicado antes da análise de um moderador.": "Use the current information as a starting point and suggest corrections. Nothing is published before moderator review.",
  "Uma edição aprovada aparece para todos após a análise da moderação.": "An approved edit appears for everyone after moderator review.",
  "Carregando animes…": "Loading anime…",
  "Animes indisponíveis no momento": "Anime temporarily unavailable",
  "Carregando destaques…": "Loading highlights…",
  "Seleção atualizada": "Updated selection",
  "Destaque editorial": "Editorial highlight",
  "Nenhuma notícia disponível no momento.": "No news is available right now.",
  "Guia Yugen": "Yugen guide",
  "Uma seleção de histórias, personagens e produções para descobrir.": "A selection of stories, characters, and productions to discover.",
  "Edição Yugen": "Yugen edition",
  "Uma curadoria do catálogo Yugen com sinopses e informações de produção para ajudar você a encontrar a próxima história.": "A curated selection from the Yugen catalog with synopses and production details to help you find your next story.",
  "Seleção Yugen": "Yugen selection",
  "Não foi possível carregar o conteúdo no momento.": "Content could not be loaded right now.",
  "Conteúdo temporariamente indisponível. Tente novamente em alguns instantes.": "Content is temporarily unavailable. Try again in a moment.",
  "Horário ainda não confirmado.": "Time not confirmed yet.",
  "Sinopse não disponível.": "Synopsis not available.",
  "Não foi possível concluir a importação agora. Tente novamente em alguns minutos.": "The import could not be completed right now. Try again in a few minutes.",
  "O envio de imagens está temporariamente indisponível. Tente novamente mais tarde.": "Image uploads are temporarily unavailable. Try again later.",
});

Object.assign(es, {
  "Carregando conteúdo": "Cargando contenido",
  "Conteúdo indisponível no momento.": "Contenido no disponible temporalmente.",
  "Não foi possível carregar esta seção. Tente novamente em alguns instantes.": "No se pudo cargar esta sección. Inténtalo de nuevo en unos instantes.",
  "Destaques temporariamente indisponíveis": "Destacados no disponibles temporalmente",
  "Em alta nesta temporada": "Tendencias de esta temporada",
  "Não foi possível carregar os destaques agora. Tente novamente em alguns instantes.": "No se pudieron cargar los destacados. Inténtalo de nuevo en unos instantes.",
  "Preparando os destaques mais recentes…": "Preparando los destacados más recientes…",
  "Personagens do Yugen": "Personajes de Yugen",
  "Não foi possível carregar este personagem no momento.": "No se pudo cargar este personaje en este momento.",
  "Perfil de personagem": "Perfil del personaje",
  "favoritos na comunidade": "favoritos de la comunidad",
  "Explore o catálogo Yugen": "Explora el catálogo de Yugen",
  "Descubra sinopses, trailers, personagens e detalhes de produção em um só lugar.": "Descubre sinopsis, tráilers, personajes y detalles de producción en un solo lugar.",
  "Catálogo Yugen": "Catálogo de Yugen",
  "Anime não encontrado.": "Anime no encontrado.",
  "Este endereço não corresponde a um anime disponível no Yugen.": "Esta dirección no corresponde a un anime disponible en Yugen.",
  "Explorar catálogo": "Explorar catálogo",
  "Carregando informações do anime": "Cargando información del anime",
  "Anime indisponível no momento.": "Anime no disponible temporalmente.",
  "Não foi possível carregar as informações deste anime. Tente novamente em alguns instantes.": "No se pudo cargar la información de este anime. Inténtalo de nuevo en unos instantes.",
  "Informações do anime": "Información del anime",
  "Use as informações atuais como ponto de partida e sugira correções. Nada é publicado antes da análise de um moderador.": "Usa la información actual como punto de partida y sugiere correcciones. Nada se publica antes de la revisión de un moderador.",
  "Uma edição aprovada aparece para todos após a análise da moderação.": "Una edición aprobada aparece para todos después de la revisión de moderación.",
  "Carregando animes…": "Cargando animes…",
  "Animes indisponíveis no momento": "Animes no disponibles temporalmente",
  "Carregando destaques…": "Cargando destacados…",
  "Seleção atualizada": "Selección actualizada",
  "Destaque editorial": "Destacado editorial",
  "Nenhuma notícia disponível no momento.": "No hay noticias disponibles en este momento.",
  "Guia Yugen": "Guía Yugen",
  "Uma seleção de histórias, personagens e produções para descobrir.": "Una selección de historias, personajes y producciones por descubrir.",
  "Edição Yugen": "Edición Yugen",
  "Uma curadoria do catálogo Yugen com sinopses e informações de produção para ajudar você a encontrar a próxima história.": "Una selección del catálogo de Yugen con sinopsis e información de producción para ayudarte a encontrar tu próxima historia.",
  "Seleção Yugen": "Selección Yugen",
  "Não foi possível carregar o conteúdo no momento.": "No se pudo cargar el contenido en este momento.",
  "Conteúdo temporariamente indisponível. Tente novamente em alguns instantes.": "Contenido no disponible temporalmente. Inténtalo de nuevo en unos instantes.",
  "Horário ainda não confirmado.": "Horario aún no confirmado.",
  "Sinopse não disponível.": "Sinopsis no disponible.",
  "Não foi possível concluir a importação agora. Tente novamente em alguns minutos.": "No se pudo completar la importación. Inténtalo de nuevo en unos minutos.",
  "O envio de imagens está temporariamente indisponível. Tente novamente mais tarde.": "La carga de imágenes no está disponible temporalmente. Inténtalo de nuevo más tarde.",
});
...
export function translateInterfaceText(
  ...
  const dynamicPatterns: Array<[RegExp, string]> = language === "en" ? [
    ...
    [/^Novo episódio de (.+) é exibido hoje$/u, "A new episode of $1 airs today"], [/^Horário previsto: (.+)\.$/u, "Expected time: $1."],
  ] : [
    ...
    [/^Novo episódio de (.+) é exibido hoje$/u, "Un nuevo episodio de $1 se emite hoy"], [/^Horário previsto: (.+)\.$/u, "Horario previsto: $1."],
  ];
